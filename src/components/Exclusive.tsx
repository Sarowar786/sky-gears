...
export default function Exclusive() {
  return (
    <div className="bg-btnColor w-full  mt-5 mb-20">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="lg:pl-9 px-4 py-10 md:py-0 flex flex-col items-start justify-center gap-4 bg-btnColor ">
          ...
          <p className="text-white w-[458px] text-base font-normal">Sky Gears has been the supplier that aircraft builders, owners, pilots, and aviation businesses have depended on since 1965. We carry a wide selection of aircraft parts.</p>
