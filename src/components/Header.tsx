      ...
      <Container className="flex items-center justify-between text-center">
        ...
        <div className="relative hidden lg:inline-flex">
          <input
            ...
            className="border w-[416px] h-[24px] py-5 pl-[24px] rounded-[4px] outline-none "
          />
          <span
            className="absolute p-[12px] top-0 right-0 duration-200 cursor-pointer text-white
